...
local Animations = {
    ...
    {
        id = 'animations:drunk',
        title = _L("menu-animation-drunk", "Drunk"),
    ...
    {
        id = 'animations:armored',
        title = _L("menu-animation-armored", "Armored"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'anim_group_move_ballistic' }
    },
    {
        id = 'animations:fire',
        title = _L("menu-animation-fire", "Wider"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
    ...
    {
        id = 'animations:fire2',
        title = _L("menu-animation-fire2", "Widest"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
    ...
    {
        id = 'animations:fire3',
        title = _L("menu-animation-fire3", "Widester"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_m@fire' }
    },
    {
        id = 'animations:franklin',
        title = _L("menu-animation-franklin", "Franklin"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_p_m_one' }
    },
    {
        id = 'animations:janitor',
        title = _L("menu-animation-janitor", "Janitor"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_p_m_zero_janitor' }
    },
    {
        id = 'animations:janitor2',
        title = _L("menu-animation-janitor2", "Janitor Slow"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_p_m_zero_slow' }
    },
    {
        id = 'animations:lester',
        title = _L("menu-animation-lester", "Lester"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_heist_lester' }
    },
    {
        id = 'animations:michael',
        title = _L("menu-animation-michael", "Michael"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_ped_bucket' }
    },
    {
        id = 'animations:sassy2',
        title = _L("menu-animation-sassy2", "Sassy 2"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
        parameters = { 'move_f@sassy' }
    },
    {
        id = 'animations:trevor',
        title = _L("menu-animation-trevor", "Trevor"),
        icon = "#animation-default",
        event = "Animation:Set:Gait",
