...
Citizen.CreateThread(function()
  ...
  for _, zone in ipairs(zones) do
    exports["vrp-polyzone"]:AddBoxZone(zone.id, zone.center, zone.width, zone.height, zone.options)
  end

  for _, target in ipairs(targets) do
    exports["vrp-polytarget"]:AddBoxZone(target.id, target.center, target.width, target.height, target.options)
  end

  -- vu building
  exports["vrp-polyzone"]:AddPolyZone("vanilla_unicorn", {
