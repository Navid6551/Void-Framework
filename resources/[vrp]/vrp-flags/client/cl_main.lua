RegisterNetEvent("vrp:flags:get")
AddEventHandler("vrp:flags:get", function(callID, netID, entityType, flagType)
    ...
    TriggerServerEvent("vrp:flags:set", callID, netID, flagType, flags)
end)

RegisterNetEvent("vrp:flags:set")
AddEventHandler("vrp:flags:set", function(netID, entityType, flagType, flags)
    local entity = nil
...
function NotifyChange(pType, pEntity, pFlag, pState)
    local event = ('vrp:flags:%s:stateChanged'):format(pType)
