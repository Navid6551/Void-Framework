...
Citizen.CreateThread(function()
  ...
  -- register
  exports["vrp-polytarget"]:AddBoxZone("wuchang_register", vector3(-830.53, -730.13, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.66,
    maxZ = 28.46,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_register", {{
      event = "vrp-foodchain:wuchangRegister",
      id = "wuchangRegister",
      icon = "dollar-sign",
  ...
  -- drinks place
  exports["vrp-polytarget"]:AddBoxZone("wuchang_drinks", vector3(-831.28, -730.19, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.26,
    maxZ = 29.06,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_drinks", {{
      event = "vrp-business:client:openWuchangDrinks",
      id = "wuchangDrinks",
      icon = "circle",
  ...
  -- music maker (wc)
  exports["vrp-polytarget"]:AddBoxZone("wuchang_music_maker", vector3(-818.17, -719.02, 32.34), 3.0, 0.6, {
    heading = 0,
    minZ = 32.14,
    maxZ = 32.74,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "vrp-music:addMusicEntry",
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "vrp-music:createMusicTapes",
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
    event = "vrp-music:deleteMusicTapes",
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "vrp-music:createMerchandise",
  ...
  -- music maker (cc)
  exports["vrp-polytarget"]:AddBoxZone("cc_music_maker", vector3(975.07, 48.05, 116.17), 0.6, 1.0, {
    heading = 58,
    minZ = 116.17,
    maxZ = 116.57,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("cc_music_maker", {{
      event = "vrp-music:addMusicEntry",
      id = "ccMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
  ...
  -- music maker (dbr)
  exports["vrp-polytarget"]:AddBoxZone("dbr_music_maker", vector3(-816.480, -704.972, 121.448), 0.8, 1.2, {
    heading = 0,
    minZ = 120.448,
    maxZ = 122.448,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("dbr_music_maker", {{
      event = "vrp-music:addMusicEntry",
      id = "dbrMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
  ...
  -- music maker (mdm)
  exports["vrp-polytarget"]:AddBoxZone("mdm_music_maker", vector3(-1469.49, -533.12, 34.74), 1.0, 1.2, {
    heading = 330,
    minZ = 34.14,
    maxZ = 35.14,
    data = {
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("mdm_music_maker", {{
      event = "vrp-music:addMusicEntry",
      id = "mdmMusicEntry",
      icon = "music",
      label = _L("restaurant-add-music-entry", "Add Music Entry"),
  ...
  exports['vrp-interact']:AddPeekEntryByPolyTarget("mdm_music_maker", {{
    ...
    -- music maker (xtc)
    exports["vrp-polytarget"]:AddBoxZone("xtc_music_maker", vector3(476.363, -93.992, 13.827), 1.0, 1.2, {
      heading = 0,
      minZ = 12.827,
      maxZ = 14.827,
      data = {
    ...
    exports['vrp-interact']:AddPeekEntryByPolyTarget("xtc_music_maker", {{
        event = "vrp-music:addMusicEntry",
        id = "xtcMusicEntry",
        icon = "music",
        label = _L("restaurant-add-music-entry", "Add Music Entry"),
        parameters = { business = "xtc_entertainment" },
    }}, { distance = { radius = 3.5 } })
    exports['vrp-interact']:AddPeekEntryByPolyTarget("xtc_music_maker", {{
        event = "vrp-music:createMusicTapes",
        id = "xtcMusicTapes",
...
RegisterUICallback("vrp-ui:wuchang:charge", function(data, cb)
...
AddEventHandler("vrp-foodchain:wuchangRegister", function()
  exports['vrp-ui']:openApplication('textbox', {
      callbackUrl = 'vrp-ui:wuchang:charge',
...
RegisterNetEvent("vrp-wuchang:activateLasers")
AddEventHandler("vrp-wuchang:activateLasers", function(doActivate)
  activateLasers(doActivate)
end)

AddEventHandler("vrp-business:client:openWuchangDrinks", function()
