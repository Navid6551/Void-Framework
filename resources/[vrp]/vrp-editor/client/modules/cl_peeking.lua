...
function startModelPeeking(data)
	...
	parameters.registerId = exports["vrp-housing"]:getCurrentPropertyID()
	parameters.business = exports['vrp-housing']:getPropertyBuisness()
	exports["vrp-interact"]:AddPeekEntryByModel({ data.model }, {{
		event = data.event,
		id = data.id,
		icon = data.icon,
		label = data.label,
