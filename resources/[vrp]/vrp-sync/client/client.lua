TriggerServerEvent("vrp:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("vrp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("vrp-sync:clientExecuteSyncNative")
AddEventHandler("vrp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
