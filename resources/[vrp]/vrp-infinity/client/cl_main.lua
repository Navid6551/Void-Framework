...
TriggerServerEvent("vrp:infinity:player:ready")

RegisterNetEvent('vrp:infinity:player:coords')
AddEventHandler('vrp:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords

    --Fucking lack of support for vector3
    TriggerEvent('vrp:infinity:player:coords:array', GetCoordsArray(PlayerCoords))
end)

RegisterNetEvent('vrp:infinity:entity:coords')
AddEventHandler('vrp:infinity:entity:coords', function (pNetId, pCoords)
    if Promises[pNetId] then
        Promises[pNetId]:resolve(pCoords)
    end

    --Fucking lack of support for vector3
    TriggerEvent('vrp:infinity:entity:coords:array', pNetId, VectorToArray(pCoords))
end)
...
function FetchEntityCoords(pNetId, pArray)
    ...
    TriggerServerEvent('vrp:infinity:entity:coords', pNetId)
    ...
    Citizen.SetTimeout(1000, function()
        ...
        TriggerEvent('vrp:infinity:entity:coords:array', pNetId, nil)
    end)
