...
ImplantItem['microchipimplant'] = async (pItemId, pItemInfo) => {
    ...
    VPX.Procedures.execute('vrp-miscscripts:implant:installed', pItemInfo);

    await new Promise((resolve) => setTimeout(resolve, 1000))

    exports['vrp-fx'].PlayEntitySound(PlayerPedId(), "Beep_Green", "DLC_HEIST_HACKING_SNAKE_SOUNDS", 1);
