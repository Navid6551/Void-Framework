    ...
    data = {
        {
            ...
            icon = "circle",
            event = "vrp-jobs:sanitationWorker:pickupTrash",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "vrp-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
  ...
  data = {
      {
          ...
          icon = "chair",
          event = "vrp-gopro:activateVRChair",
          parameters = { type = "pd" }
      },
  },
  options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "vrp-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "vrp-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          icon = "hand-holding",
          event = "vrp-heists:grabFromTrolley",
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "vrp-business:bench:dismantle",
            parameters = {},
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "box",
            event = "vrp-inventory:openDumpster",
            parameters = {},
        }
    },
    options = {
