...
VehicleEntries[#VehicleEntries+1] = {
    ...
    isEnabled = function(pEntity, pContext)
      return not IsDisabled() and exports['vrp-vehicles']:HasVehicleKey(pEntity) and exports['vrp-vehicles']:IsOnParkingSpot(pEntity, false) and not IsPedInAnyVehicle(PlayerPedId(), false)
    end
}
...
VehicleEntries[#VehicleEntries+1] = {
  data = {
      ...
      event = "vrp-jobs:impound:openImpoundRequestMenu",
      parameters = {}
  },
  isEnabled = function(pEntity, pContext)
...
VehicleEntries[#VehicleEntries+1] = {
    data = {
        ...
        icon = "#vehicle-impound",
        event = "vrp-jobs:impound:openImpoundMenu",
    },
    isEnabled = function(pEntity, pContext)
