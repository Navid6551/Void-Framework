...
Housing.TO_TEXT = {
    ...
    ['v_int_53'] = 'Shop High',
    ['empty_house_shop'] = 'Empty Shop L',
    ['empty_house2'] = 'Empty Shop M',
    ['empty_house3'] = 'Empty Shop S'
  }
...
AddEventHandler("vrp-config:configLoaded", function (configId, config)
    if configId ~= "vrp-housing" then return end
...
AddEventHandler(IsDuplicityVersion() and "onServerResourceStart" or "onClientResourceStart", function (resource)
    ...
    local config = exports["vrp-config"]:GetModuleConfig("vrp-housing")
