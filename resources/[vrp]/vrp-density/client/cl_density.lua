...
AddEventHandler('vrp-gopro:activateVRChair', function ()
  density = 0.0
  print('pausing polulation', density)
end)
...
AddEventHandler('vrp-density:disable', function (pDensity, pRogue)
...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('vrp:peds:rogue', toDelete)
      end
...
RegisterNetEvent('vrp:peds:rogue:delete')
AddEventHandler('vrp:peds:rogue:delete', function(pNetId)
...
RegisterNetEvent('vrp:peds:decor:set')
AddEventHandler('vrp:peds:decor:set', function (pNetId, pType, pProperty, pValue)
  local entity = NetworkGetEntityFromNetworkId(pNetId)
