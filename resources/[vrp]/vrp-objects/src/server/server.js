...
const addObject = (pData) => {
  ...
  emitNet('8:objects:prepareNewObject', -1, pData)
}
...
const updateObject = (pData) => {
  ...
  emitNet('8-objects:updateObjects', -1, pData)
}
...
const deleteObject = (pData) => {
  ...
  emitNet('8-objects:clearObjects', -1, pData)
}
globalThis.exports('deleteObject', deleteObject)

onNet('8-objects:requestObjects', async () => {
  let src = source
  ...
  emitNet('8-objects:loadObjects', src, pObjects)
})
onNet(
  '8-objects:prepareObject',
  async (
    _0x5a1c03,
    _0xec222f,
    _0x4e2296,
    ...
    emitNet('8:objects:prepareNewObject', -1, _0x5aa71c)
  }
)
RPC.register(
  '8-objects:SaveObject',
  async (
    pSource,
    pNs,
    pModel,
    ...
    return emitNet('8:objects:prepareNewObject', -1, _0x588249), true
  }
)
RPC.register('8-objects:DeleteObject', async (_0x1d3045, _0x2078ee) => {
  ...
  return (
    !!(await SQL.execute('DELETE FROM __objects WHERE id = @id', {
      id: _0x2078ee,
    })) && (emitNet('8-objects:clearObjects', -1, _0x1edca6), true)
  )
})

RPC.register(
  '8-objects:UpdateObject',
  async (_0x2f99f7, _0x49819b, _0x25e634) => {
    ...
    return emitNet('8-objects:updateObjects', -1, _0x201f32), true
  }
)