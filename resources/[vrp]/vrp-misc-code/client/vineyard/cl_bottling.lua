RegisterUICallback("vrp-vineyard:setupWineboxContainer", function(data, cb)
  ...
  if data.key.item == "vineyardwinebox" then
    RPC.execute("vrp-restaurants:getTakeoutBox", {
...
AddEventHandler("vrp-inventory:itemUsed", function(pItem, pData)
  ...
  exports["vrp-ui"]:openApplication("textbox", {
    callbackUrl = "vrp-vineyard:setupWineboxContainer",
...
AddEventHandler("vrp-inventory:itemUsed", function(pItem, pData)
  ...
  local amount = exports["vrp-inventory"]:getQuantity("wineglass", true, false)
  if amount == 0 then
  ...
  Wait(250)
  info._name = "Glass of " .. (info._name and info._name or "Unnamed")
  info._image_url = nil
