        ...
        floors = {
            {
                ...
                teleport = {
                    ...
                    heading = 151.5,
                    onArriveEvent = "vanta-casino:enterHotel",
                },
                zone = {
            ...
            },
            {
                ...
                teleport = {
                    ...
                    heading = 51.58,
                    onArriveEvent = "vanta-casino:enterPenthouse",
                },
                zone = {
            ...
            },
            {
                ...
                teleport = {
                    ...
                    heading = 49.08,
                    onArriveEvent = "vanta-casino:elevatorExitCasino",
                },
                zone = {
            ...
            },
            {
                ...
                teleport = {
                    ...
                    heading = 244.09,
                    onArriveEvent = "vanta-casino:elevatorEnterCasino",
                },
                zone = {
        ...
        floors = {
            {
                ...
                teleport = {
                    ...
                    heading = 292.15,
                    onArriveEvent = "vanta-paintball:leaveStadium", -- leave
                    onLeaveEvent = "vanta-paintball:enterStadium", -- enter
                },
                zone = {
            ...
            },
            {
                ...
                teleport = {
                    ...
                    heading = 14.4,
                    onArriveEvent = "vanta-paintball:enterArena",
                    onLeaveEvent = "vanta-paintball:leaveArena",
                },
                zone = {
        ...
        floors = {
            {
                ...
                teleport = {
                    coords = vector3(-769.11, 336.66, 243.37),
                    heading = 88.56,
                },
                zone = {
                    center = vector3(-768.56, 337.62, 243.38),
                    width = 0.3,
                    length = 0.2,
                    target = true,
                    options = { headling = 2.0, minZ = 243.38, maxZ = 243.78 },
                },
                locked = false,
            },
            {
                name = "Main Floor",
                description = "Street Exit",
                teleport = {
                    coords = vector3(-777.06988525391, 322.36206054688, 85.661972045898),
                    heading = 179.63725280762,
                },
                zone = {
                    center = vector3(-775.53, 323.04, 85.66),
                    width = 0.5,
                    length = 0.3,
                    target = true,
                    options = { headling = 0.0, minZ = 85.96, maxZ = 86.36 },
                },
                locked = false,
            },
        },
