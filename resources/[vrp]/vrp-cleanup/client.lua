...
AddEventHandler("vrp-cleanup:enableCleanup", function(pEnabled)
  skipCleanupChecks = not pEnabled
end)

AddEventHandler("vrp-cleanup:addBlacklistedProp", function(pProp)
...
local bypassObjects = {}
AddEventHandler('vrp-objects:objectCreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)

AddEventHandler('vrp-objects:objectDeleted', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('vrp-objects:objectRecreating', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('vrp-objects:objectRecreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)
...
RegisterNetEvent('vrp-cleanup:clearAreaOfEverything')
AddEventHandler('vrp-cleanup:clearAreaOfEverything', function (vectors, radius)
    ClearAreaOfEverything(vectors.x, vectors.y, vectors.z, radius, false, false, false, false)
end)

RegisterNetEvent('vrp-cleanup:clearAreaOfObjects')
AddEventHandler('vrp-cleanup:clearAreaOfObjects', function (vectors, radius)
    ClearAreaOfObjects(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('vrp-cleanup:clearAreaOfPeds')
AddEventHandler('vrp-cleanup:clearAreaOfPeds', function (vectors, radius)
    ClearAreaOfPeds(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('vrp-cleanup:clearAreaOfVehicles')
AddEventHandler('vrp-cleanup:clearAreaOfVehicles', function (vectors, radius)
