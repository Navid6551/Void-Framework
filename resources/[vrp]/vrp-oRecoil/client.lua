...
Citizen.CreateThread(function()
  exports["vrp-keybinds"]:registerKeyMapping("", "Player", "Crouch", "+moveCrouch", "-moveCrouch", "X")
...
AddEventHandler('vrp-police:cuffs:state', function(handCuffedSent,WalkingSent)
