local houseOptions = {
    ...
    {['id'] = 'empty_house_shop', ['name'] = 'Empty Shop L'},
    {['id'] = 'empty_house2', ['name'] = 'Empty Shop M'},
    {['id'] = 'empty_house3', ['name'] = 'Empty Shop S'},
}
...
function openAttatchTextbox()
    ...
    local items = {
        ...
        { _type = 'select', label = 'Business', name = 'buisness', options = businessOptions },
    }
