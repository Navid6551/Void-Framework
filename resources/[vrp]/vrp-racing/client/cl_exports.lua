...
function getHasRaceUsbAndAlias()
  ...
  local racingCreateUsbItem = exports["vrp-inventory"]:GetInfoForFirstItemOfName("racingusb0")
  local racingUsbItem = exports["vrp-inventory"]:GetInfoForFirstItemOfName("racingusb2")
  local pdRacingUsbItem = exports["vrp-inventory"]:GetInfoForFirstItemOfName("racingusb3")
...
function canJoinOrStartRace(expectedVehicleClass)
  ...
  local vehicleClass = exports["vrp-boosting"]:GetVehicleClassByModel(vehicleModel)
