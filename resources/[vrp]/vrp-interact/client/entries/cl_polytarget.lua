...
Entries[#Entries + 1] = {
    type = 'polytarget',
    group = { 'vrp-jail:prison_services' },
    data = {
        {
            id = "prison_services",
            label = _L("interact-prison-services", "Prison Services"),
            icon = "circle",
            event = "vrp-jail:services",
            parameters = {}
        }
    },
    options = {
