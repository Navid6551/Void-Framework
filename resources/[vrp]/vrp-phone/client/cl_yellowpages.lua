RegisterUICallback("vrp-ui:getYellowPages", function(data, cb)
...
RegisterUICallback("vrp-ui:addYellowPagesEntry", function(data, cb)
...
RegisterUICallback("vrp-ui:deleteYellowPagesEntry", function(data, cb)
...
RegisterCommand("phone:twatter-receive", function()
  SendUIMessage({
    ...
    data = {
      ...
      character = { -- this is sent with the tweet (vrp-ui:twatSend) so just relay it
        id = 123,
        first_name = "Fuck",
        last_name = "Off"
      },
