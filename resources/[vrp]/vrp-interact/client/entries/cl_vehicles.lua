    ...
    data = {
        {
            ...
            icon = "user-secret",
            event = "vrp-police:vehicle:getInTrunk",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "user-secret",
            event = "vrp-police:vehicle:forceTrunkCheck",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["vrp-vehicles"]:HasVehicleKey(pEntity) and exports["vrp-inventory"]:hasEnoughOfItem("fakeplate", 1, false, true)
            and not exports["vrp-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
            and not exports["vrp-vehicles"]:GetVehicleMetadata(pEntity, 'boosting_scratch')
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 3.0 },
        isEnabled = function(pEntity, pContext)
            return (not IsPedInAnyVehicle(PlayerPedId(), false) and GetBoneDistance(pEntity, 2, 'wheel_rf') <= 1.7 and pContext.model == GetHashKey("mule") and exports["vrp-inventory"]:hasEnoughOfItem("homemadekey", 1, false)  )
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 3.0 },
        isEnabled = function(pEntity, pContext)
            return (not IsPedInAnyVehicle(PlayerPedId(), false) and GetBoneDistance(pEntity, 2, 'wheel_rf') <= 1.7 and pContext.model == GetHashKey("mule") and not exports["vrp-inventory"]:hasEnoughOfItem("homemadekey", 1, false)  )
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["vrp-vehicles"]:HasVehicleKey(pEntity) and exports["vrp-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "wrench",
            event = "vrp:vehicles:examineVehicle",
            parameters = {}
        }
    },
    options = {
  ...
  data = {
      {
          ...
          icon = "money-bill",
          NPXEvent = "vrp-boosting:s2:purchaseVehicle",
          parameters = {}
      }
  },
  options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return HasWeaponEquipped(883325847) and exports['vrp-business']:HasPermission('sanguine_isle', 'property_keys') -- WEAPON_PetrolCan
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    data = {
        ...
        },
        {
            ...
            event = "vrp-police:vehicle:unseat",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "vrp-boosting:scratchVehicleVin",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "vrp-meth:dropoff:cancelDropOff",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cubes",
            event = "vrp-meth:dropoff:doDropoff",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "wheelchair",
            event = "vrp:vehicle:wheelchair:control",
            parameters = {}
        }
    },
    options = {
  ...
  data = {
      {
          ...
          NPXEvent = "vrp-ottosauto:vehicle:transaction",
          parameters = {
            business = "ottos_auto",
            action = "sell"
          }
    ...
    data = {
        {
            ...
            icon = "unlink",
            event = "vrp-vehicles:checkTampering",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "shopping-cart",
            event = "vrp-police:client:openRhinoArmoy",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cut",
            event = "vrp-miscscripts:carBombs:removeBomb",
            parameters = {}
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "people-carry",
            event = "vrp-rcvehicles:pickupCar",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "plus",
            event = "vrp-car-clothing:saveCurrentOutfit",
            parameters = {},
        },
        {
            ...
            icon = "redo",
            event = "vrp-car-clothing:swapCurrentOutfit",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "eye-slash",
            event = "vrp-heroin:seeds:cancelSeeds",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "cubes",
            event = "vrp-heroin:seeds:doDropoff",
            parameters = {}
        }
    },
    options = {
...
--           label = "Use Thermite",
--           icon = "circle",
--           event = "vrp-heists:bobcatThermiteMoneyTruckDoor",
--           parameters = {}
--       }
--   },
--   options = {
...
--             and exports["vrp-inventory"]:hasEnoughOfItem("thermitecharge", 1, false, true)
--       end
--   }
-- }
...
--           label = "Take Goods",
--           icon = "circle",
--           event = "vrp-heists:bobcatMoneyTruckTakeGoods",
--           parameters = {}
--       }
--   },
--   options = {
