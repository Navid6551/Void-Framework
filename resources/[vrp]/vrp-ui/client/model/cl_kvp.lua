...
RegisterNUICallback("vrp-ui:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("vrp-hud:settings", data.key, data.value)
...
RegisterNUICallback("vrp-ui:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('vrp-preferences')
  return json.decode(result or "{}")
end
