...
local cookingPeekEntries = {
  {
    event = "vrp-business:cleanManor:cookSteak",
...
local cookingPeekModels = {
  ...
  [`prop_beach_bbq`] = vector3(0.0, 0.0, 0.13),
}
...
CreateThread(function()
  ...
  exports["vrp-polytarget"]:AddBoxZone(
    "guildmanor_prepare_steak",
    vector3(-1503.57, 109.56, 55.58), 0.5, 0.5,
    {
      minZ=55.38,
      maxZ=55.78,
      heading=317
  ...
  exports["vrp-interact"]:AddPeekEntryByPolyTarget(
    "cleanmanor_prepare_steak",
    {{
      event = "vrp-business:cleanManor:prepareSteak",
  ...
  exports["vrp-polytarget"]:AddBoxZone(
    "cleanmanor_stove",
    vector3(-1791.36, 424.69, 128.25), 1, 1,
    {
      min = 127.3,
      maxZ = 129
    }
...
AddEventHandler("vrp-business:cleanManor:prepareSteak", function()
  local src = source
  local hasItem = exports["vrp-inventory"]:hasEnoughOfItem("beef", 1, false, true);
  ...
  local finished = exports["vrp-taskbar"]:taskBar(30000, "Preparing Steak")
...
AddEventHandler("vrp-business:cleanManor:cookSteak", function(params, entity)
  local src = source
  local doneness = params.doneness or "medium_steak"
  local cookTime = params.cookTime or 180000
  local hasItem = exports["vrp-inventory"]:hasEnoughOfItem("raw_steak", 1, false, true);
  ...
  local finished = exports["vrp-taskbar"]:taskBar(cookTime, "Cooking Steak")
