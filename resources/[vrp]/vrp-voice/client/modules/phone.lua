...
function LoadPhoneModule()
    ...
    RegisterNetEvent("vrp:voice:phone:call:start")
    AddEventHandler("vrp:voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("vrp:voice:phone:call:end")
    AddEventHandler("vrp:voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("vrp:voice:phone:ready")

    Debug("[Phone] Module Loaded")
end

RegisterNetEvent('vrp-voice:setTransmissionDisabled', function ()
    WasEventCanceled()
