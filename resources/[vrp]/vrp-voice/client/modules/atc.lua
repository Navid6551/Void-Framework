...
function ConnectToATCFrequency()
    local subscribers = RPC.execute('vrp-voice:atc:subscribe')
...
function DisconnectFromATCFrequency()
    ...
    RPC.execute('vrp-voice:atc:unsubscribe')
...
function LoadATCModule()
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
    ...
    RegisterNetEvent('vrp-voice:atc:connect', ConnectToATCFrequency)

    RegisterNetEvent('vrp-voice:atc:disconnect', DisconnectFromATCFrequency)

    RegisterNetEvent('vrp-voice:atc:setPowerState', SetATCRadioPowerState)

    RegisterNetEvent('vrp-voice:atc:addSubscriber', AddATCSubscriber)

    RegisterNetEvent('vrp-voice:atc:removeSubscriber', RemoveATCSubscriber)
