RegisterUICallback("vrp-ui:getLicenses", function(data, cb)
...
RegisterUICallback("vrp-ui:getAllLicenses", function(data, cb)
  local success, message = RPC.execute("GetAllLicenses")
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("vrp-ui:getCharacterPermissions", function(data, cb)
  local success, message = RPC.execute("GetStateAccess")
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("vrp-ui:getStateCharacterDetails", function(data, cb)
  local success, message = RPC.execute("GetCharacterDetails", data)
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("vrp-ui:revokeLicense", function(data, cb)
...
RegisterUICallback("vrp-ui:grantLicense", function(data, cb)
