Citizen.CreateThread(function()
  exports["vrp-polytarget"]:AddBoxZone("vrp-business:lifeinvader:manageListings", vector3(-1053.24, -230.85, 44.32), 1.8, 0.9,
                                      { heading = 301, minZ = 43.82, maxZ = 44.82 })
  exports["vrp-polytarget"]:AddBoxZone("vrp-business:lifeinvader:frontDesk", vector3(-1082.36, -247.24, 38.07), 1.3, 3.4,
                                      { heading = 207, minZ = 37.52, maxZ = 38.62 })

  exports["vrp-polytarget"]:AddBoxZone("vrp-business:lifeinvader:dd_basement", vector3(1129.59, -468.32, 62.81), 2.2, 0.9,
                                      { heading = 346, minZ = 62.31, maxZ = 63.31 })

  exports["vrp-interact"]:AddPeekEntryByPolyTarget("vrp-business:lifeinvader:manageListings", {
    {
      id = "vrp-business:lifeinvader:manageListings",
      event = "vrp-business:lifeinvader:manageListings",
      icon = "list-alt",
  ...
  exports["vrp-interact"]:AddPeekEntryByPolyTarget("vrp-business:lifeinvader:dd_basement", {
    {
      id = "vrp-business:lifeinvader:sendSystemMail",
      event = "vrp-business:lifeinvader:sendSystemMail",
      icon = "envelope-open",
      label = "Send SYS Mail",
    },
  }, {
  ...
  exports["vrp-interact"]:AddPeekEntryByPolyTarget("vrp-business:lifeinvader:frontDesk", {
    {
      id = "vrp-business:lifeinvader:frontDesk",
      event = "vrp-business:lifeinvader:frontDesk",
      icon = "envelope-open-text",
      label = "sign up for lifeinvader mail",
    },
    {
      id = "vrp-business:lifeinvader:changeEmail",
      event = "vrp-business:lifeinvader:changeEmail",
      icon = "envelope-open-text",
...
AddEventHandler("vrp-business:lifeinvader:manageListings", function()
  ...
  local context = { { title = "Ad Listings" }, { title = "Create Add Listing", icon = "plus", action = "vrp-ui:li:createAdListing" } }
  ...
  for i, ad in ipairs(ads) do
    ...
    context[#context + 1] = {
      ...
      children = {
        ...
        { title = "Remove", icon = "trash", action = "vrp-ui:li:removeAdListing", key = ad.id },
      },
    }
  end
...
RegisterUICallback("vrp-ui:li:createAdListing", function(data, cb)
  Wait(0)
...
RegisterUICallback("vrp-ui:li:removeAdListing", function(data, cb)
...
AddEventHandler("vrp-business:lifeinvader:sendSystemMail", function()
...
local function showEmailPrompt(pFromUpdate)
  ...
  local success, message = RPC.execute("vrp-phone:setEmailAddress", email, pFromUpdate)
  if not success then
    TriggerEvent("DoLongHudText", message, 2)
    return false
  end

  TriggerEvent("vrp-ui:updateCharacterData")
  TriggerEvent("DoLongHudText", "Your email address is now " .. email, 1)
  return true
end

AddEventHandler("vrp-business:lifeinvader:frontDesk", function()
...
AddEventHandler("vrp-business:lifeinvader:changeEmail", function()
  local hasEmail = RPC.execute("vrp-phone:getEmailAddress")
