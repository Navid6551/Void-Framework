...
RegisterNetEvent("vrp-admin:horse", function(pOn)
    if not pOn then
        inHorseMode = false
...
RegisterCommand("vrp-admin:horseon", function()
    TriggerServerEvent("vrp-admin:shorseon")
end, false)
RegisterCommand("vrp-admin:horseoff", function()
    TriggerServerEvent("vrp-admin:shorseoff")
end, false)
