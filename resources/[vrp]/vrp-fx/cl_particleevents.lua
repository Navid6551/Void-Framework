...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("vrp-fx:setSteamId")
end)
RegisterNetEvent("vrp-fix:setSteamIdClient")
AddEventHandler("vrp-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["vrp-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
