...
Citizen.CreateThread(function()
    ...
    data = {
        {
            ...
            label = "Set Trailer",
            icon = "circle",
            event = "vrp-miscscripts:vehicletrailer:set",
            parameters = {},
        },
				{
					...
					label = "Open Trailer",
					icon = "circle",
					event = "vrp-miscscripts:vehicletrailer:openDoor",
					parameters = {},
				},
				{
					...
					label = "Close Trailer",
					icon = "circle",
					event = "vrp-miscscripts:vehicletrailer:closeDoor",
					parameters = {},
				},
				{
					...
					icon = "circle",
					event = "vrp-miscscripts:vehicletrailer:lowerTop",
					parameters = {},
				},
				{
					...
					icon = "circle",
					event = "vrp-miscscripts:vehicletrailer:toggleTop",
					parameters = {},
				}
    },
    options = {
  ...
  exports["vrp-interact"]:AddPeekEntryByEntityType(entry.group, entry.data, entry.options)
end)
...
RegisterNetEvent("vrp-miscscripts:vehicletrailer:set")
AddEventHandler("vrp-miscscripts:vehicletrailer:set", function(pContext, pEntity)
	trailer = pEntity
	TriggerEvent("DoLongHudText", "Successfully set trailer", 1, 12000, { i18n = { "Successfully set trailer" } })
end)

RegisterNetEvent("vrp-miscscripts:vehicletrailer:openDoor")
AddEventHandler("vrp-miscscripts:vehicletrailer:openDoor", function(pContext, pEntity)
...
RegisterNetEvent("vrp-miscscripts:vehicletrailer:closeDoor")
AddEventHandler("vrp-miscscripts:vehicletrailer:closeDoor", function(pContext, pEntity)
...
RegisterNetEvent("vrp-miscscripts:vehicletrailer:toggleTop")
AddEventHandler("vrp-miscscripts:vehicletrailer:toggleTop", function(pContext, pEntity)
	Sync.SetVehicleDoorShut(pEntity, 4, 0, 1)
end)

RegisterNetEvent("vrp-miscscripts:vehicletrailer:lowerTop")
AddEventHandler("vrp-miscscripts:vehicletrailer:lowerTop", function(pContext, pEntity)
