PlayerPed, CurrentTarget, CurrentTargetCoords, IsInVehicle = nil, nil, nil, false
    ...
    while true do
        ...
        if entity and entityType ~= 0 then
            if entity ~= CurrentTarget then
                ...
                TriggerEvent('vrp:target:changed', CurrentTarget, entityType, entityCoords)
            end
        elseif CurrentTarget then
            CurrentTarget = nil
            TriggerEvent('vrp:target:changed', CurrentTarget)
        end
