...
function SetRadioFrequency(pFrequency, pSendAppEvent)
    if CanUseFrequency(pFrequency, true) then
        ...
        local success = RPC.execute("vrp-voice:addPlayerToRadio", pFrequency)
        ...
        exports["vrp-ui"]:sendAppEvent("game", { radioChannel = tostring(pFrequency) })
        if pSendAppEvent then
            exports["vrp-ui"]:sendAppEvent("radio", { value = pFrequency })
        end
...
function SetRadioChannel(radioID)
    ...
    exports["vrp-ui"]:sendAppEvent("game", { radioChannel = tostring(radioID) })
...
function StartTransmission()
    ...
    if not IsTalkingOnRadio then
        ...
        TriggerEvent("vrp:voice:transmissionStarted", { radio = true })
...
function LoadRadioModule()
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk", "+transmitToRadio", "-transmitToRadio", "CAPITAL")
    RegisterCommand('+transmitToRadio', StartTransmission, false)
    RegisterCommand('-transmitToRadio', StopTransmission, false)

    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk (Secondary)", "+secondaryTransmitToRadio", "-secondaryTransmitToRadio")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Volume Up", "+increaseRadioVolume", "-increaseRadioVolume")
    RegisterCommand('+increaseRadioVolume', IncreaseRadioVolume, false)
    RegisterCommand('-increaseRadioVolume', function() end, false)

    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Volume Down", "+decreaseRadioVolume", "-decreaseRadioVolume")
    RegisterCommand('+decreaseRadioVolume', DecreaseRadioVolume, false)
    RegisterCommand('-decreaseRadioVolume', function() end, false)

    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "On / Off", "+toggleRadioState", "-toggleRadioState")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Channel Up", "+increaseRadioChannel", "-increaseRadioChannel")
    RegisterCommand('+increaseRadioChannel', increaseRadioChannel, false)
    RegisterCommand('-increaseRadioChannel', function() end, false)

    exports["vrp-keybinds"]:registerKeyMapping("", "Radio", "Channel Down", "+decreaseRadioChannel", "-decreaseRadioChannel")
    RegisterCommand('+decreaseRadioChannel', decreaseRadioChannel, false)
    RegisterCommand('-decreaseRadioChannel', function() end, false)

    RegisterNetEvent("vrp:voice:radio:connect")
    AddEventHandler("vrp:voice:radio:connect", ConnectToRadio)

    RegisterNetEvent("vrp:voice:radio:disconnect")
    AddEventHandler("vrp:voice:radio:disconnect", DisconnectFromRadio)

    RegisterNetEvent("vrp:voice:radio:added")
    AddEventHandler("vrp:voice:radio:added", AddRadioSubscriber)

    RegisterNetEvent("vrp:voice:radio:removed")
    AddEventHandler("vrp:voice:radio:removed", RemoveRadioSubscriber)

    RegisterNetEvent("vrp:voice:radio:power")
    AddEventHandler("vrp:voice:radio:power", SetRadioPowerState)

    RegisterNetEvent("vrp:voice:radio:volume")
    AddEventHandler("vrp:voice:radio:volume", SetRadioVolume)
    ...
    TriggerEvent("vrp:voice:radio:ready")
