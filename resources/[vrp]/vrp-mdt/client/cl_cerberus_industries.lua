Citizen.CreateThread(function()
  exports["vrp-polytarget"]:AddBoxZone("cerb_indsutries_craft", vector3(-1787.94, 460.39, 94.37), 1.6, 1, {
    heading=35,
    minZ=93.37,
    maxZ=95.37,
  })
  exports["vrp-polytarget"]:AddBoxZone("cerb_indsutries_craft_cia", vector3(1612.29, 2656.53, -158.27), 1, 1, {
    heading=270,
    minZ=-158.27,
    maxZ=-157.47,
  })
  exports["vrp-polytarget"]:AddBoxZone("cerb_indsutries_craft_arena", vector3(5520.87, 5985.68, 590.0), 1, 1, {
    heading=0,
    minZ=589.8,
    maxZ=590.6,
  })
  exports["vrp-polyzone"]:AddBoxZone("cerb_armory_elevator_shaft", vector3(1630.6083984, 2659.0908203, -70.3896408), 8.2, 15.2, {
    heading=0,
    minZ=-164.4,
    maxZ=20.8,
  })

  exports["vrp-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft", {{
    id = 'ci_craft_wingsuits',
    label = 'Cerberus Industries',
    icon = 'circle',
    event = "vrp-cerb-industries:craftStuff",
    parameters =  { id = "420ci_wingsuits" },
  }}, { distance = { radius = 1.5 } })

  exports["vrp-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft_cia", {{
    id = 'cia_craft',
  ...
  exports["vrp-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft_arena", {{
    id = 'ci_craft_misc',
    label = 'Misc',
    icon = 'circle',
    event = "vrp-cerb-industries:craftStuff",
...
AddEventHandler("vrp-cerb-industries:craftStuff", function(p1, p2, p3)
...
RegisterNetEvent("vrp-cbc:iplStatesUpdate", function(pStates)
  iplStates = pStates
  updateIpls()
end)

Citizen.CreateThread(function()
  TriggerServerEvent("vrp-cbc:getIplsStates")
end)
...
-- local timePlaces = {}
-- RegisterNetEvent("vrp-cia:elevator", function(pDir)
