...
function Build.func.buildPeeking(plan)
	...
	exports["vrp-interact"]:AddPeekEntryByModel({ peek.model }, {{
		event = peek.event,
		id = peek.id,
		icon = peek.icon,
		label = peek.label,
		...
		isEnabled = function(pEntity)
		  return exports["vrp-housing"]:isInRobbery()
		end
	})
