Citizen.CreateThread(function()
  exports["vrp-polytarget"]:AddBoxZone("tuner_laptop", vector3(125.38, -3014.74, 7.04), 0.6, 0.8, {
    minZ=6.69,
    maxZ=7.49,
    heading=0
  })
  ...
  exports["vrp-interact"]:AddPeekEntryByPolyTarget(
    ...
    {
      {
        event = "vrp-business:openTunershopLaptop",
  ...
  exports["vrp-polyzone"]:AddBoxZone("vrp-fx:audio:stage", vector3(140.63, -3014.36, 10.7), 2.2, 1.4, {
    minZ = 9.7,
    maxZ = 12.3,
    heading = 0,
    data = {
...
RegisterNetEvent("vrp-business:openTunershopLaptop")
AddEventHandler("vrp-business:openTunershopLaptop", function()

  if not IsEmployedAt("tuner") then
    return TriggerEvent("DoLongHudText", "Doesn't seem like I have access to this...", 2)
  end

  exports["vrp-laptop"]:OpenLaptop({ }, { "tunershop:showBrowserTab" }, {
