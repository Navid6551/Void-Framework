...
function ConnectToDTFrequency(pIsHeadset)
    local subscribers = RPC.execute('vrp-voice:drivethru:subscribe')
...
function DisconnectFromDTFrequency()
    ...
    RPC.execute('vrp-voice:drivethru:unsubscribe')
    DTIsHeadset = false
...
function LoadDTModule()
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Push-To-Talk", "+transmitToDriveThru", "-transmitToDriveThru")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "DriveThru Headset", "On / Off", "+toggleDTRadioState", "-toggleDTRadioState")
    ...
    exports["vrp-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Up", "+increaseDTVolume", "-increaseDTVolume")
    RegisterCommand('+increaseDTVolume', IncreaseDTRadioVolume, false)
    RegisterCommand('-increaseDTVolume', function() end, false)

    exports["vrp-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Down", "+decreaseDTRadioVolume", "-decreaseDTRadioVolume")
    ...
    RegisterNetEvent('vrp-voice:drivethru:connect', ConnectToDTFrequency)

    RegisterNetEvent('vrp-voice:drivethru:disconnect', DisconnectFromDTFrequency)

    RegisterNetEvent('vrp-voice:drivethru:setPowerState', SetDTRadioPowerState)

    RegisterNetEvent('vrp-voice:drivethru:addSubscriber', AddDTSubscriber)

    RegisterNetEvent('vrp-voice:drivethru:removeSubscriber', RemoveDTSubscriber)

    -- scuffed way of overriding vanilla keybind
    AddEventHandler('vrp:voice:transmissionStarted', function()
