...
AddEventHandler("vrp-business:kettle", function(data)
  local src = source
  local hasWater = exports["vrp-inventory"]:hasEnoughOfItem("water", 1, false, true);
  ...
  local finished = exports["vrp-taskbar"]:taskBar(kettleTime, "Brewing a cuppa")
