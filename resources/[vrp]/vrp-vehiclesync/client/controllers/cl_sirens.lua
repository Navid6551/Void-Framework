...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('vrp-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('vrp-vehicleSync:updateSirenState')
AddEventHandler('vrp-vehicleSync:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
Citizen.CreateThread(function()
    exports["vrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["vrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["vrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["vrp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)

AddEventHandler('vrp-vehicleSync:disableAllSirens', DisableAllSirens)
AddEventHandler('vrp-vehicleSync:enableAllSirens', EnableAllSirens)
