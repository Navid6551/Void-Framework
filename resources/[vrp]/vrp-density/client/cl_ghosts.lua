...
AddEventHandler('vrp-config:configLoaded', function (pId)
                ...
                if inside and not Ghosted[vehicle] then
                    ...
                    if not isPlayer then
                        ...
                        if Config.antiGhostYeetVehicles then
                            TriggerEvent('vrp-density:yeet', vehicle)
                        end
                    end
...
AddEventHandler('vrp-density:yeet', function (vehicle)
    -- local vin = exports['vrp-vehicles']:GetVehicleIdentifier(vehicle)

    -- if vin then return end

    -- exports['vrp-sync']:SyncedExecution('DeleteEntity', vehicle)
end)
