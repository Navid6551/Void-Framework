...
AddEventHandler('vrp-inventory:itemUsed', function(pItem)
  ...
  local finished = exports['vrp-ui']:taskBarSkill(math.random(1500, 4500), math.random(10, 25))
  ...
  TriggerServerEvent('vrp-goldpanning:getLoot', myCoords, rollCount)
...
AddEventHandler('vrp-inventory:itemUsed', function(pItem)
  ...
  -- TriggerServerEvent('vrp-goldpanning:checkProbeSpot', GetEntityCoords(PlayerPedId()))
end)


AddEventHandler('vrp-goldpanning:markLocation', function()
  local location = VPX.Procedures.execute('vrp-goldpanning:getCurrentLocation')
  ...
  AddTextComponentString('Gold Panning Area')
