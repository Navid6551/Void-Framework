...
CreateThread(function ()
    exports["vrp-polytarget"]:AddBoxZone("deeznotes_craft", vector3(-560.03, 283.34, 85.38), 1.0, 2, {
        heading=355,
        minZ=84.38,
        maxZ=86.92,
    })
    exports["vrp-interact"]:AddPeekEntryByPolyTarget("deeznotes_craft", {{
        id = 'deeznotes',
        label = 'Craft Guitars',
        icon = 'circle',
        event = "vrp-business:deeznotes:craft",
...
AddEventHandler("vrp-business:deeznotes:craft", function ()
...
function stringsInserted(originInventory, targetInventory, originSlot, targetSlot, originItemId, targetItemId, originItemInfo, targetItemInfo)
    ...
    local itemInfo = exports['vrp-inventory']:GetItemInfo(targetSlot)
