RegisterUICallback("vrp-ui:getAccounts", function(data, cb)
...
RegisterUICallback("financials/getTransactions", function(data, cb)
  local success, transactions = RPC.execute("GetTransactionLogs", data.data.account_id, data.data.type)
  cb({ data = transactions, meta = { ok = true, message = 'done' }})
end)

RegisterUICallback("financials/uploadTransactions", function(data, cb)
...
-- CREATE ACCOUNT
RegisterUICallback("vrp-ui:createAccount", function(data, cb)
...
-- EDIT ACCOUNT
RegisterUICallback("vrp-ui:editAccount", function(data, cb)
...
-- TODO: Backend Hookup
-- DELETE ACCOUNT
RegisterUICallback("vrp-ui:deleteAccount", function(data, cb)
  local id = data.id
...
-- GET ACCOUNT TYPES
RegisterUICallback("vrp-ui:getAccountTypes", function(data, cb)
...
RegisterUICallback("vrp-ui:getAccountCharacters", function(data, cb)
...
RegisterUICallback("vrp-ui:addAccountCharacterPermissions", function(data, cb)
...
RegisterUICallback("vrp-ui:editAccountCharacterPermissions", function(data, cb)
  local account_id, cid, access = data.account.id, data.character.id, data.character.access
  local success, message = RPC.execute("EditCharacterPermission", account_id, cid, access)
  cb({ data = {}, meta = { ok = success, message = (not success and message or 'done') } })
end)

RegisterUICallback("vrp-ui:removeCharacterFromAccount", function(data, cb)
