RegisterUICallback("vrp-ui:smsSend", function(data, cb)
...
RegisterUICallback("vrp-ui:getMessages", function(data, cb)
...
RegisterUICallback("vrp-ui:getConversations", function(data, cb)
...
AddEventHandler("phone:readPlayerconversations", function(pServerId)
  ...
  if pServerId ~= nil then
    ...
    if success then
      ...
      exports["vrp-ui"]:openApplication("burner", { source_number  = pPhoneNumber, isOwner = false })
    end
  end
end)
