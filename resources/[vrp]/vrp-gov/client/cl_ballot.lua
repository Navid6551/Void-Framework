RegisterUICallback("vrp-ui:getBallots", function(data, cb)
...
RegisterUICallback("vrp-ui:createBallot", function(data, cb)
...
RegisterUICallback("vrp-ui:editBallot", function(data, cb)
...
RegisterUICallback("vrp-ui:deleteBallot", function(data, cb)
  local id = data.id
  local success, message = RPC.execute("DeleteBallot", id)
  cb({ data = {}, meta = { ok = success, message = (not success and message or 'done') } })
end)

RegisterUICallback("vrp-ui:addBallotOption", function(data, cb)
...
RegisterUICallback("vrp-ui:deleteBallotOption", function(data, cb)
  local id = data.id
  local success, message = RPC.execute("DeleteBallotOption", id)
  cb({ data = {}, meta = { ok = success, message = (not success and message or 'done') } })
end)

RegisterUICallback("vrp-ui:getCurrentBallotOptions", function(data, cb)
  local success, message = RPC.execute("GetBallots")
  cb({ data = message, meta = { ok = success, message = (not success and message or 'done') } })
end)

RegisterUICallback("vrp-ui:submitBallotChoices", function(data, cb)
