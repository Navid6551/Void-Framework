...
RegisterNetEvent("vrp-ui:open-application")
AddEventHandler("vrp-ui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("vrp-ui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("vrp-ui:soundPlay")
AddEventHandler("vrp-ui:soundPlay", function(name, volume, loop)
