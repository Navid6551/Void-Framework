...
itemList['repairkit'] = {
  ...
  craft: [[{ itemid: 'agenericmechanicpart', amount: 12 }]],
  price: 1000,
  weight: 10,
  nonStack: false,
  model: '',
...
itemList['blindfold'] = {
  ...
  craft: [
    [
      { itemid: 'merchingredient', amount: 100 },
    ]
  ],
  model: '',
...
itemList['np_prop_cs_walking_stick'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Cane',
  price: 350,
...
itemList['mobilewatervendor'] = {
  ...
  information: 'Place it down anywhere and have a drink! 60 Day Rental',
};
...
itemList['mobilefoodvendor'] = {
  ...
  information: 'Place it down anywhere and have some food! 60 Day Rental',
};
...
itemList['mobileatm'] = {
  ...
  information: 'Get some cash from anywhere! 60 Day Rental',
};
...
itemList['closed_gy_coffin'] = {
  ...
  image: 'np_coffin.png',
  information: "RIPBOZO",
  placeableObject: "closed_gy_coffin",
  placeableInfo: "Property of - That’s Life",
};
...
itemList['chickenmanstatue'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_chickenman.png',
  information: "Richard Fritz <br><br><i>The Chicken Man</i>",
  placeableObject: "np_prop_chickenman",
...
itemList['crystal_black'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_crystal_black.png',
  information: "Black Crystal",
  placeableObject: "np_crystal_single_black",
...
itemList['crystal_purple'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_crystal_purple.png',
  information: "Purple Crystal",
  placeableObject: "np_crystal_single_purple",
...
itemList['crystal_orange'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_crystal_orange.png',
  information: "Orange Crystal",
  placeableObject: "np_crystal_single_orange",
...
itemList['isaac_eye'] = {
  ...
  placeableObject: "np_grey_eyeball",
...
itemList['deploy_wedding_blue'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Blue Wedding Venue',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  image: 'np_flowers.png',
  information: "Blue Wedding Venue. 24 Hour Rental",
  deployableObject: "denis3d_wedding_preset_blue",
  deployableExpires: 60 * 60 * 24,
};

itemList['deploy_wedding_pink'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Pink Wedding Venue',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  image: 'np_flowers.png',
  information: "Pink Wedding Venue. 24 Hour Rental",
  deployableObject: "denis3d_wedding_preset_pink",
  deployableExpires: 60 * 60 * 24,
};

itemList['deploy_wedding_red'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Red Wedding Venue',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  image: 'np_flowers.png',
  information: "Red Wedding Venue. 24 Hour Rental",
  deployableObject: "denis3d_wedding_preset_red",
  deployableExpires: 60 * 60 * 24,
};

itemList['deploy_wedding_white'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'White Wedding Venue',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  image: 'np_flowers.png',
  information: "White Wedding Venue. 24 Hour Rental",
  deployableObject: "denis3d_wedding_preset_white",
  deployableExpires: 60 * 60 * 24,
};

itemList['deploy_wedding_yellow'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Yellow Wedding Venue',
  price: 8000,
  weight: 11,
  nonStack: false,
  model: '',
  image: 'np_flowers.png',
  information: "Yellow Wedding Venue. 24 Hour Rental",
  deployableObject: "denis3d_wedding_preset_yellow",
  deployableExpires: 60 * 60 * 24,
};
...
itemList['deploy_np_xmasbigbaubles'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmasbigbaubles",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasextrabigbaubles'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmasbigbaubles_l",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasgiftstack'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmasgiftstack",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasbiggiftstack'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmasgiftstack_l",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmaslollipop'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmaslollipop",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasbiglollipop'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmaslollipop_l",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmaslamp'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmaslamp",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasbigsnowfam'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  image: 'np_christmas_present.png',
  information: "Fam",
  deployableObject: "np_xmassnowfam_l",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmasstocking'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmas_stocking",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmaswreath'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  image: 'np_christmas_present.png',
  information: "Hang me",
  deployableObject: "np_xmas_wreath",
  deployableExpires: 60 * 60 * 24 * 21,
};

itemList['deploy_np_xmassantacutout'] = {
  fullyDegrades: true,
  decayrate: 0.3,
  ...
  deployableObject: "np_xmasclause",
  deployableExpires: 60 * 60 * 24 * 21,
};
...
itemList['deploy_banana_peel'] = {
  ...
  deployableObject: "np_banana_peel",
...
itemList['littlemoscow_passport'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_littlemoscow_passport.png',
  information: 'Товарищ',
  craft: [
    [
      { itemid: 'plastic', amount: 3 },
...
itemList['herodrenaline_syringe'] = {
  fullyDegrades: true,
  decayrate: 2.0,
  displayname: 'The Juice',
  price: 1,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_herodrenaline.png',
  information: '',
  contraband: true,
};
...
itemList['deployable_tray'] = {
  ...
  model: '',
  image: 'np_shop_tray.png',
  information: 'Nice to hold things. 12 Hour Rental',
...
itemList['msimonebody'] = {
  ...
  placeableObject: 'np_michael_corpse',
...
itemList['msimonecapture'] = {
  ...
  placeableObject: 'np_michael_captured',
...
itemList['bundy_sign'] = {
  ...
  image: 'np_temp.png',
  information: "",
  deployableObject: "np_bundy_sign",
...
itemList['npma_2022'] = {
  ...
  nonStack: true,
  model: '',
  image: 'np_music_award_2022.gif',
  information: 'NoPixel Music Award (2022)',
};
...
itemList['boarding_pass_cayo'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_boarding_pass_cayo.png',
  information: "Los Santos -> Sanguine Isle",
};
...
itemList["fishingzebraplecos"] = {
	...
	nonStack: false,
	model: "",
	image: "np_fishingzebraplecos.png",
	information:
...
itemList["fishingdwarfpuffer"] = {
	...
	nonStack: false,
	model: "",
	image: "np_fishingdwarfpuffer.png",
	information:
...
itemList['orange_saber'] = {
  ...
  illegal: false,
  decayrate: 0.0,
  displayname: 'Orange Pixel Saber',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
...
itemList['red_t_saber'] = {
  ...
  illegal: false,
  decayrate: 0.0,
  displayname: 'Red Triple Pixel Saber',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
...
itemList['duel_disk'] = {
  ...
  illegal: false,
  decayrate: 0.0,
  displayname: 'NoPixel Duel Disk',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_duel_disk.png',
  information: 'Time to DUEL!',
  contraband: false,
};

itemList['icbmwarhead'] = {
  fullyDegrades: true,
  decayrate: 1,
  displayname: 'ICBM Warhead',
  price: 100,
  weight: 250,
  craft: [
    [
...
itemList['ollyrancherbag'] = {
  fullyDegrades: true,
  decayrate: 1.0,
  displayname: 'Bag Of Olly Rancher',
  price: 150,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_ollyrancherbag.png',
};

itemList['emptystyrofoamcup'] = {
  fullyDegrades: false,
  decayrate: 1.0,
  displayname: 'Empty Styrofoam Cup',
  price: 150,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_styrofoamcup.png',
  information: 'Smells like olly ranchers.',
};

itemList['ollyrancher'] = {
  fullyDegrades: true,
  decayrate: 1.0,
  displayname: 'Olly Rancher',
  price: 150,
  weight: 1,
  nonStack: false,
  model: '',
  image: 'np_ollyrancher.png',
  information: 'Sticks to your teeth.',
};
...
itemList['remotedet'] = {
  ...
  nonStack: false,
  model: '',
  image: 'np_remote_det.png',
  information: 'Used to detonate something remotely.',
};

itemList['sanguine_isle_passport'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Sanguine Isle Passport',
  price: 0,
  weight: 1,
  nonStack: true,
  model: '',
  image: 'np_si_passport.png',
  craft: [
    [
      { itemid: 'plastic', amount: 3 },
    ],
...
itemList['subradio'] = {
  fullyDegrades: false,
  decayrate: 0.0,
  displayname: 'Submarine Radio',
  price: 0,
  weight: 0,
  nonStack: true,
  model: '',
  image: 'np_subradio.png',
};

itemList['metamorphine_box'] = {
  fullyDegrades: true,
  illegal: true,
  decayrate: 2.50,
  displayname: 'Metamorphine box',
  price: 150,
  weight: 10,
  craft: [
    [
      { itemid: 'oxy', amount: 20 },
      { itemid: '883325847', amount: 1 },
      { itemid: 'paint_thinner', amount: 1 },
      { itemid: 'coughsyrup', amount: 1 },
      { itemid: 'glass', amount: 100 },
    ],
  ],
  nonStack: false,
  model: '',
  image: 'np_box-of-weed-12-18-oz.png',
  information: 'Dumpster Flu Shot in a neat package',
  contraband: true,
  friskable: 2,
};