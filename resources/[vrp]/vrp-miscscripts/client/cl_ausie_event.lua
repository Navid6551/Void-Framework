...
RegisterNetEvent('vrp-miscscripts:ausieEvent:explosionByStander', function ()
...
RegisterNetEvent('vrp-miscscripts:ausieEvent:explosionOrigin', function ()
...
Citizen.CreateThread(function()
    exports["vrp-polyzone"]:AddCircleZone("vrp-miscscripts:explosionArea", vector3(-1381.78, -484.02, 63.74), 100.0, {
        useZ=true,
        data = {
          id = "delperro",
        },
...
VPX.Zones.onEnter("vrp-miscscripts:explosionArea", function(zone)
...
VPX.Zones.onExit("vrp-miscscripts:explosionArea", function(zone)
...
AddEventHandler("vrp-inventory:itemUsed", function(item)
    ...
    TriggerServerEvent("vrp-miscscripts:aussie:boom")
end)